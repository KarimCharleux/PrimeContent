    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-4 md:p-6 xl:p-8">
        ...
        >
          ...
          <a href={href} className="inline-flex items-center text-blue-300 hover:text-blue-100 text-sm md:text-base group transition-all duration-300" style={{ transitionDelay: '0.2s' }}>
