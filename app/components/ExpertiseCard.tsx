...
export default function ExpertiseCard({
    ...
    // Contenu commun (arrière-plan, icône, titre)
    const commonContent = (
        <>
            {/* Animation CSS */}
            <style jsx>{`
    ...
    // Version mobile - avec icône de lien et sans lien interne
    const mobileContent = (
        <motion.div
        ...
        >
            {/* Icône cliquable - mobile uniquement */}
            ...
            {/* Contenu de la carte - version mobile simplifiée */}
    ...
    // Version desktop - avec description et lien interne
    const desktopContent = (
        ...
        >
            ...
            {/* Contenu de la carte - version desktop complète */}
            <div className="relative z-10 h-full flex flex-col justify-end p-2 sm:p-3 md:p-4 lg:p-6">
                ...
                {/* Description et bouton - desktop uniquement */}
                <div
                    className="overflow-hidden transition-all duration-700 ease-in-out max-h-0 group-hover:max-h-[150px] sm:group-hover:max-h-[200px] opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0"
    ...
    return (
        <div className="w-full h-full">
            {/* Sur mobile/tablet : wrapper Link avec contenu sans lien interne */}
            ...
            {/* Sur desktop : contenu avec lien interne, pas de wrapper Link */}
            <div className="hidden xl:block w-full h-full">{desktopContent}</div>
        </div>
    );
}
