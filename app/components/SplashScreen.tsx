...
export default function SplashScreen({ onLoadingComplete }: SplashScreenProps) {
  ...
  // Détection de Safari
  useEffect(() => {
    // Détecte Safari en vérifiant la présence de certaines propriétés spécifiques à Safari
  ...
  useEffect(() => {
    const updateZoomPosition = () => {
      ...
      // Valeurs ajustées pour une meilleure compatibilité cross-browser
      if(width <= 400) {
            ...
            <motion.div
              ...
              animate={isAnimationComplete ? 
                (isSafari ? {
                  ...
                  // Animation pour les autres navigateurs
