    ...
    useEffect(() => {
        ...
        const loadData = setTimeout(() => {
            ...
            setRecentActivities([
                {
                    id: '1',
                    type: 'message',
                    title: 'Nouveau message de Julie Dupont',
                    date: '10 juin 2023',
                },
                {
                    id: '2',
                    type: 'photo',
                    title: 'Nouvelle photo ajoutée à la galerie Mariage',
                    date: '9 juin 2023',
                },
                {
                    id: '3',
                    type: 'event',
                    title: 'Événement "Gala annuel" créé',
                    date: '8 juin 2023',
                },
                {
                    id: '4',
                    type: 'client',
                    title: 'Nouveau client: Thomas Martin',
                    date: '7 juin 2023',
                },
                {
                    id: '5',
                    type: 'video',
                    title: 'Nouvelle vidéo téléchargée: "Mariage Martin"',
                    date: '6 juin 2023',
                },
            ]);
            ...
            setUpcomingTasks([
                {
                    id: '1',
                    title: 'Séance photo pour Thomas',
                    dueDate: '18 juin 2023',
                    priority: 'high',
                    completed: false,
                },
                {
                    id: '2',
                    title: 'Édition vidéo - Mariage Durand',
                ...
                {
                    id: '3',
                    title: 'Appel client - Préparation événement',
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            {upcomingTasks.map((task) => (
                                <div
                                    key={task.id}
                                    className="flex items-start p-3 border border-gray-100 hover:bg-gray-50 rounded-lg transition-colors"
                                >
                                    <input
                                        type="checkbox"
