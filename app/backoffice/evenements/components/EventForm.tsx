...
interface EventFormProps {
    ...
    setFormData: React.Dispatch<React.SetStateAction<Partial<Evenement>>>;
    handleSubmit: (e: React.FormEvent, data: Partial<Evenement>) => Promise<void>;
    handleCancel: () => void;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                <label htmlFor="toggle-visible" className="text-sm text-gray-700 ml-2">
                    ...
                    <div>
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className={`p-4 border rounded-lg cursor-pointer transition-colors ${formData.type === 'selection' ? 'border-pink-500 bg-pink-50' : 'border-gray-300 hover:border-gray-400'}`}
                                    ...
                                    <p className="text-xs text-gray-500 ml-6">
                                        Les utilisateurs peuvent sélectionner et acheter des photos individuellement.
                                    </p>
                                </div>

                                <div className={`p-4 border rounded-lg cursor-pointer transition-colors ${formData.type === 'paye' ? 'border-amber-500 bg-amber-50' : 'border-gray-300 hover:border-gray-400'}`}
                                ...
                                <div className={`p-4 border rounded-lg cursor-pointer transition-colors ${formData.type === 'non_paye' ? 'border-teal-500 bg-teal-50' : 'border-gray-300 hover:border-gray-400'}`}
                        ...
                        {formData.type === 'selection' && (
                            <div className="mt-6 p-6 border border-pink-200 rounded-lg bg-pink-50">
                                <h4 className="text-md font-medium mb-4">Options de tarification</h4>
                                ...
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData({ ...formData, prixParPhoto: parseFloat(e.target.value) })}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                                ...
                                <div className="mb-2">
                                    ...
                                    <p className="text-xs text-gray-500 mb-2">
                                        Définissez des remises en fonction du nombre de photos achetées.
                                    </p>
                                    
                                    {formData.tarifDegressif && formData.tarifDegressif.length > 0 ? (
                                        <div className="space-y-3">
                                            {formData.tarifDegressif.map((tarif, index) => (
                                                <div key={index} className="flex items-center space-x-4 p-3 bg-white rounded-lg border border-pink-100">
                                                    <div className="flex-1">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => updateTarifDegressif(index, 'quantite', parseInt(e.target.value))}
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => updateTarifDegressif(index, 'pourcentageRemise', parseInt(e.target.value))}
                                                            className="w-full px-2 py-1 border border-gray-300 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 text-sm"
                                                        />
                                                    </div>
                                                    <button
                                                        type="button"
                                                        onClick={() => supprimerTarifDegressif(index)}
                                        ...
                                        <div className="text-center py-4 bg-white rounded-lg border border-dashed border-gray-300">
                                            <p className="text-sm text-gray-500">Aucun tarif dégressif défini</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="mb-4">
                            <div className="flex items-center">
                                ...
                                <label htmlFor="protection" className="text-sm text-gray-700 ml-2">
                                    {formData.protectionMotDePasse?.actif ? 'Protégé' : 'Non protégé'}
                                </label>
                            </div>
                            <p className="mt-1 text-xs text-gray-500">
                                    ...
                                    <div className="flex space-x-2">
                                        <input
                                            ...
                                            onChange={(e) => setFormData({
                                                ...formData,
                                                protectionMotDePasse: {
                                                    ...(formData.protectionMotDePasse || { actif: true }),
