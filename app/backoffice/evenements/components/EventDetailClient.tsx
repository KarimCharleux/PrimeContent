...
export default function EventDetailClient({ eventId }: EventDetailClientProps): JSX.Element {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            {statusMessage && (
                <div
                    className={`mb-6 p-4 rounded-md ${statusMessage.type === 'success' ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}
                >
                    {statusMessage.message}
                </div>
            )}
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="mb-3">
                                ...
                                <p className="font-medium">
                                    {evenement.categorie || 'Non spécifiée'}
                                </p>
                            </div>
                            <div className="mb-3">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="mb-3 bg-blue-50 p-2 rounded">
                                ...
                                <p className="text-sm font-bold">
                                    {mediaStats.totalMedias} ({mediaStats.totalImages} images •{' '}
                                    {mediaStats.totalVideos} vidéos)
                                </p>
                            </div>
                            <div className="mb-3 bg-green-50 p-2 rounded">
                                ...
                                <p className="text-xs text-gray-500">
                                    Images: {formatSize(mediaStats.imagesSize)} • Vidéos:{' '}
                            ...
                            <div className="bg-purple-50 p-2 rounded">
                                ...
                                <p className="text-sm font-bold">
                                    {formatLoadTime(mediaStats.averageLoadTime)}
                                </p>
