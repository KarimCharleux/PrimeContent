...
// Cette fonction est nécessaire pour Next.js static export
export async function generateStaticParams() {
  // Pour une construction statique, nous pouvons soit:
  // 1. Retourner un tableau vide et laisser les routes être générées à la demande
  // 2. Récupérer tous les IDs d'événements depuis Firestore (pas pratique en production)
  
  // Option 1: Retourner un tableau vide (recommandé pour le backoffice)
  return [];
  
  // Option 2: Précharger tous les IDs (exemple)
  /*
  try {
