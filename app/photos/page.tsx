        ...
        <main className="global-main-page">
            ...
            <section className="px-4 py-16 min-h-screen">
                <div className="container mx-auto">
                    ...
                    >
                        <h1 className="page-title underline-title">PHOTOS</h1>
                    </motion.div>
                    ...
                    >
                        Découvrez nos services : mariages, portraits, événements, commerce, mode et
                        projets artistiques, adaptés à vos besoins.
                    </motion.p>
